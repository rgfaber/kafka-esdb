...
func GetTextMapCarrierFromEvent(event common.Event) opentracing.TextMapCarrier {
...
func StartProjectionTracerSpan(ctx context.Context, operationName string, event common.Event) (context.Context, opentracing.Span) {
