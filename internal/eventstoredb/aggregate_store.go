...
func (a *aggregateStore) Load(ctx context.Context, aggregate common.Aggregate) error {
	...
	for {
		...
		esEvent := common.NewEventFromRecorded(event.Event)
...
func (a *aggregateStore) Save(ctx context.Context, aggregate common.Aggregate) error {
